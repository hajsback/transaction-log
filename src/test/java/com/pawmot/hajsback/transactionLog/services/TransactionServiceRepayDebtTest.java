...
public class TransactionServiceRepayDebtTest {
    @Mock
    private RepayDebtRequestValidator validator;
    ...
    public void shouldReturnOKIfValidatorAcceptsInput() {
        ...
        // when
        Result result = service.repayDebt(RepayDebtRequest.builder().build(), "any@mail.uk");
